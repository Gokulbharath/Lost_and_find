  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 transition-colors duration-300">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 className="text-3xl font-bold mb-8 text-gray-900 dark:text-white">My Reports</h1>
        {loading ? (
          <div className="text-center py-16 text-gray-500">Loading...</div>
        ) : (
          <>
            <section className="mb-12">
              <h2 className="text-2xl font-semibold mb-4 text-red-600">Lost Items Reported</h2>
              {lostItems.length > 0 ? (
                ...
                <div className="text-gray-500">No lost items reported.</div>
              )}
            </section>
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-green-600">Found Items Reported</h2>
              {foundItems.length > 0 ? (
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                  {foundItems.map(item => (
                ...
                <div className="text-gray-500">No found items reported.</div>
              )}
            </section>
          </>
        )}
